...
public class BuildingPir extends BaseFilePri{
	...
	/**升级消耗道具(等级，道具ID，数量)*/
	Object cost_item;
	/**清理消耗资源(只有障碍物才使用改字段)    typeCash = 1,typeEarth = 2,typeOil = 3,typeSteel = 4, typeDiamond = 5,（填写格式3,100;4,100   消耗资源类型,资源数量）*/
	Object cost_type;
	...
	/**属性*/
	Object attr;
	/**建筑功能    1,信息;2,升级;3,增益;4,状态;5,生产;6,科技升级;7,装甲蓝图;8,制造;9,储物箱;10,驻军;11,生化配件;12,复活;13,商店;14,敌情;15,关押;16,贸易;17,驻军装甲;18,修理;19,改造;20,驻防;21,传送;22,容量(pending);23,开采;24,提速;25,采钢;26,采金;27,采油;28,采土;29,旋转;30,整列;31,重新布置;32,清理;*/
	Object function;
	/**基地摧毁参数*/
	double para;
	/**音效*/
