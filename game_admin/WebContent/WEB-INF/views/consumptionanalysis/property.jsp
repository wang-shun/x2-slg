			...
			<div class="gm-main">
				<div class="easyui-panel">
					...
					<table class="easyui-datagrid" style="min-height:200px" id="dg"
						data-options="singleSelect:true,striped:true,url:'/consumptionanalysis/analysis/propertyjson',fitColumns:true,emptyMsg:'暂无数据'">
						<thead>
							<tr>
								<th data-options="field:'property',width:40">道具</th>
								<th data-options="field:'propertyType',width:40">道具类型</th>
