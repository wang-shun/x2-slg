		...
		<div class="gm-content">
			...
			<div class="gm-main">
				<div class="easyui-panel">
					...
					<table title="科技等级达成人数" class="easyui-datagrid" style="min-height:200px" id="dg"
						data-options="singleSelect:true,striped:true,url:'/systemanalysis/analysis/sciencejson',fitColumns:true,emptyMsg:'暂无数据'">
						<thead>
							<tr>
								<th data-options="field:'id',width:40">ID</th>
								<th data-options="field:'name',width:40">名称</th>
								<th data-options="field:'level1',width:40">1级人数</th>
								<th data-options="field:'level2',width:40">2级人数</th>
								<th data-options="field:'level3',width:40">3级人数</th>
								<th data-options="field:'level4',width:40">4级人数</th>
								<th data-options="field:'level5',width:40">5级人数</th>
								<th data-options="field:'level6',width:40">6级人数</th>
								<th data-options="field:'level7',width:40">7级人数</th>
								<th data-options="field:'level8',width:40">8级人数</th>
								<th data-options="field:'level9',width:40">9级人数</th>
								<th data-options="field:'level10',width:40">10级人数</th>
							</tr>
						</thead>
					</table>
					<div style="padding:2px 5px;background-color: #F5F5F5">
					...
					<table title="科技研究累计时间" class="easyui-datagrid" style="min-height:200px" id="dg1"
						data-options="singleSelect:true,striped:true,url:'/systemanalysis/analysis/sciencejsontime',fitColumns:true,emptyMsg:'暂无数据'">
						<thead>
							<tr>
