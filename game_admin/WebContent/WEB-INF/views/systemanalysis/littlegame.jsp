			...
			<div class="gm-main">
				<div class="easyui-panel">
					...
					<table class="easyui-datagrid" style="min-height:200px" id="dg"
						data-options="singleSelect:true,striped:true,url:'/systemanalysis/analysis/littlegamejson',fitColumns:true,emptyMsg:'暂无数据'">
						<thead>
							<tr>
								<th data-options="field:'date',width:40">日期</th>
								<th data-options="field:'clock0',width:40">模拟设计次数</th>
								<th data-options="field:'clock1',width:40">模拟战争次数</th>
							</tr>
						</thead>
					</table>
				</div>
