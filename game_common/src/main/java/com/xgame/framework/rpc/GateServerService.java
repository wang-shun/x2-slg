...
public class GateServerService {
  ...
  public interface Iface {
    ...
    public void regiest(String ip, int port, int area) throws org.apache.thrift.TException;
  ...
  public interface AsyncIface {
    ...
    public void regiest(String ip, int port, int area, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void regiest(String ip, int port, int area) throws org.apache.thrift.TException
    {
      send_regiest(ip, port, area);
      recv_regiest();
    }

    public void send_regiest(String ip, int port, int area) throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void regiest(String ip, int port, int area, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException {
      checkReady();
      regiest_call method_call = new regiest_call(ip, port, area, resultHandler, this, ___protocolFactory, ___transport);
    ...
    public static class regiest_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      private int port;
      private int area;
      public regiest_call(String ip, int port, int area, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class regiest<I extends Iface> extends org.apache.thrift.ProcessFunction<I, regiest_args> {
      ...
      public regiest_result getResult(I iface, regiest_args args) throws org.apache.thrift.TException {
        regiest_result result = new regiest_result();
        iface.regiest(args.ip, args.port, args.area);
        return result;
      }
    }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class regiest<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, regiest_args, Void> {
      ...
      public void start(I iface, regiest_args args, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler) throws TException {
        iface.regiest(args.ip, args.port, args.area,resultHandler);
      }
    }
