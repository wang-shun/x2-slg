...
public class ReqDealInviteHandler extends PlayerCommand<ReqDealInviteMessage>{
	...
	@Override
    public void action() {
		allianceManager.dealAllianceInvite(player, message.allianceId, message.result == ACCEPT);
	}
}
