...
public class ReqDeleteTeamMemberHandler extends PlayerCommand<ReqDeleteTeamMemberMessage>{
	...
	@Override
    public void action() {
		allianceManager.kickTeamMemeber(player, message.alliaceId, message.targetPlayerId, message.teamId);
    }
}
