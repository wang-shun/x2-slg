...
public class ReqOpenTimeRefreshTaskHandler extends PlayerCommand<ReqOpenTimeRefreshTaskMessage>{
	...
	@Override
    public void action() {
		taskManager.openTimeRefreshTask(player, message.type, message.id);
    }
}
