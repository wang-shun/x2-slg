...
public class ReqAllianceAcitivityHandler extends PlayerCommand<ReqAllianceAcitivityMessage>{
	...
	@Override
    public void action() {
		allianceExtManager.allianceActivity(player, message.allianceId);
	}
}
