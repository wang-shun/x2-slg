...
public class ReqChangeLeaderHandler extends PlayerCommand<ReqChangeLeaderMessage>{
	...
	@Override
    public void action() {
		allianceManager.changeAllianceLeader(player, message.alliaceId, message.targetPlayerId);
	}
}
