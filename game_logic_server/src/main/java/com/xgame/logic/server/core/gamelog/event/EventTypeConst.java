...
public class EventTypeConst {
	...
	/** 侦查玩家*/
	public static final int SCOUT = 29;
	/** 攻击玩家*/
	...
	/** 发送邮件*/
	public static final int EMAIL_SEND = 49;
	/** 请求生产士兵*/
	public static final int SOLDIER_PRODUCT_START = 50;
	/** 开始采集*/
	public static final int COLLECT_START = 51;
	/** 矿车产量发生变化*/
	public static final int MINE_PRODUCT_UPDATE = 52;
	
	// -----------------------------------------------指挥官---------------------------------------------------------
	/** 指挥官升级*/
	public static final int EVENT_COMMAND_LEVELUP = 1001; 
	/** 指挥官改名*/
	public static final int EVENT_COMMANDER_CHANGE_NAME =1002; 
	/** 增加体力*/
	public static final int EVENT_COMMANDER_REFRESH_ENERGY = 1003;
	/** 增加天赋点*/
	public static final int ADD_TALENT = 1004;
	/** 穿戴装备*/
	public static final int USE_EQUIPMENT = 1005;
	/** 卸下装备*/
	public static final int UNUSE_EQUIPMENT = 1006;
	
	
	// ------------------------------------------------联盟-----------------------------------------------------------
	/** 加入联盟*/
	public static final int EVENT_ALLIANCE_JOIN = 2001; 
	/** 离开联盟*/
	public static final int EVENT_ALLIANCE_LEFT = 2002; 
	/** 创建联盟*/
	public static final int EVENT_CREATE_ALLIANCE = 2003;
	/** 联盟升级*/
	public static final int EVENT_LEVELUP_ALLIANCE = 2004;
	/** 推出联盟*/
	public static final int EVENT_EXIT_ALLIANCE = 2005;
	/** 军团捐献*/
	public static final int ALLIANCE_DONATE = 2006;
	/** 军团援建*/
	public static final int ALLIANCE_AID = 2007;
	/** 发布军团招募*/
	public static final int ALLIANCE_PUBLISH_RECRUIT = 2008;
	/** 发布集结*/
	public static final int ALLIANCE_BUILD_UP = 2009;
	/** 刷新军团商店*/
	public static final int REFLRESH_LEAGUE_SHOP = 2010;
	/** 军团商店兑换*/
	public static final int LEAGUE_SHOPPING = 2011;
	/** 创建联盟建筑*/
	public static final int ALLIANCE_BUILD_CREATE = 2012;
	/** 升级联盟建筑*/
	public static final int ALLIANCE_BUILD_LEVEL_UP = 2013;
	/** 移动联盟建筑*/
	public static final int ALLIANCE_BUILD_MOVE = 2014;
	/** 删除联盟建筑*/
	public static final int ALLIANCE_BUILD_REMOVE = 2015;
	/** 升级联盟科技*/
	public static final int ALLIANCE_SCIENCE_LEVEL_UP = 2016;
	/** 联盟改名*/
	public static final int ALLIANCE_NAME_CHANGE = 2017;
	/** 联盟简称修改*/
	public static final int ALLIANCE_ABBR_CHANGE = 2018;
}
