 ...
 *
 */
public class AllianceBuildCreateEventObject extends GameLogEventObject {
	/**
	 * 建筑id
	 */
	...
	public AllianceBuildCreateEventObject(Player player,int buildTId,Vector2Bean position) {
