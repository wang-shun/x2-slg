...
public class ReqAllianceScienceListHandler extends PlayerCommand<ReqAllianceScienceListMessage>{
	...
	@Override
    public void action() {
		allianceExtManager.getAllianceScienceList(player, message.allianceId);
	}
}
