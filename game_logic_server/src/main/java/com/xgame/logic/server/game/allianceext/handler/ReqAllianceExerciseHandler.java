...
public class ReqAllianceExerciseHandler extends PlayerCommand<ReqAllianceExerciseMessage>{
	...
	@Override
    public void action() {
		allianceExtManager.allianceExerciseInfo(player, message.allianceId);
	}
}
