 ...
 * AllianceExt-ResAssignReward - 返回分配奖励信息
 */
public class ResAssignRewardMessage extends ResMessage {
	
	//模块号+消息号
	public static final int ID=1210117;
	//模块号
	...
	public String toString(){
		...
		buf.append("awardBean:" + awardBean +",");
