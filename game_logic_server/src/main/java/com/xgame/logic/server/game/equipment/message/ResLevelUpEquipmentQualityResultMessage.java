 ...
 * Equipment-ResLevelUpEquipmentQualityResult - 是否升品质成功
 */
public class ResLevelUpEquipmentQualityResultMessage extends ResMessage {
	
	//模块号+消息号
	public static final int ID=300108;
	//模块号
