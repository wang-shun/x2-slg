 ...
 * Alliance-ResAllianceChange - 联盟信息变更
 */
public class ResAllianceChangeMessage extends ResMessage {
	
	//模块号+消息号
	public static final int ID=1007199;
	//模块号
	public static final int FUNCTION_ID=1007;
	//消息号
	public static final int MSG_ID=199;
