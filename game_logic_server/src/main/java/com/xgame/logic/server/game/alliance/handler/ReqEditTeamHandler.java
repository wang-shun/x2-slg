...
public class ReqEditTeamHandler extends PlayerCommand<ReqEditTeamMessage>{
	...
	@Override
    public void action() {
		allianceManager.editTeam(player, message.alliaceId, message.teamId, message.teamName, message.icon);
    }
}
