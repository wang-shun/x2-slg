 ...
 * 
 */
package com.xgame.logic.server.game.timertask.entity;
...
import com.xgame.logic.server.core.metric.MeterDescription;
import com.xgame.logic.server.core.metric.ThreadPoolMeter;
				...
				new RejectedExecutionHandler() {
					...
					public void rejectedExecution(Runnable r, ThreadPoolExecutor executor) {
						try {
							...
							r.run();
							MeterDescription description = new ThreadPoolMeter("排队线程池", executor).meter();
							log.error("排队线程池拒绝提交任务, 当前线程池情况：{}", description.toString());
