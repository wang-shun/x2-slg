...
public class ReqAllianceScienceDonateHandler extends PlayerCommand<ReqAllianceScienceDonateMessage>{
	...
	@Override
    public void action() {
		allianceExtManager.allianceScienceDonate(player, message.allianceId, message.scienceTid, message.type);
	}
}
