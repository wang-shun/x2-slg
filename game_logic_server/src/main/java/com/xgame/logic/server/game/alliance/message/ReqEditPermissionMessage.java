 ...
 * Alliance-ReqEditPermission - 编辑权限
 */
public class ReqEditPermissionMessage extends ReqMessage {
	
	//模块号+消息号
	public static final int ID=1007241;
	//模块号
	public static final int FUNCTION_ID=1007;
	//消息号
	public static final int MSG_ID=241;
	...
	/**权限信息*/
	@MsgField(Id = 2)
	public AlliancePermissionBean permission;
