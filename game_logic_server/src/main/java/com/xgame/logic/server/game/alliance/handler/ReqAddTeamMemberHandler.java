...
public class ReqAddTeamMemberHandler extends PlayerCommand<ReqAddTeamMemberMessage>{
	...
	@Override
    public void action() {
		allianceManager.addTeamMember(player, message.alliaceId, message.targetPlayerId, message.teamId);
    }
}
