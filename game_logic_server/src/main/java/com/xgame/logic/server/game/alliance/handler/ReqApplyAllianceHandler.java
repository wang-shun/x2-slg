...
public class ReqApplyAllianceHandler extends PlayerCommand<ReqApplyAllianceMessage>{
	...
	@Override
    public void action() {
		allianceManager.applyAlliance(player, message.allianceId, message.applyNotice);
    }
}
