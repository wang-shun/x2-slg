...
public class ReqPlayerAllianceExtHandler extends PlayerCommand<ReqAcitivityRankMessage>{
	...
	@Override
    public void action() {
		allianceExtManager.getPlayerAllianceExt(player, message.allianceId);
	}
}
