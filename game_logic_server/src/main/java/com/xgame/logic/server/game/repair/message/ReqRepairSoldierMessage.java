 ...
 * Repair-ReqRepairSoldier - 请求修理
 */
public class ReqRepairSoldierMessage extends ReqMessage {
	
	//模块号+消息号
	public static final int ID=105201;
	//模块号
	...
	/**士兵信息*/
	@MsgField(Id = 2)
	public List<SoldierBean> soldierList = new ArrayList<SoldierBean>();
