...
public class ReqRewardActivityResourceHandler extends PlayerCommand<ReqRewardActivityResourceMessage>{
	...
	@Override
    public void action() {
		allianceExtManager.rewardActivityResource(player, message.allianceId);
	}
}
