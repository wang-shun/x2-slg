...
public class ReqAllianceBuildLvHandler extends PlayerCommand<ReqAllianceBuildLvMessage>{
	...
	@Override
    public void action() {
		allianceExtManager.levelUpAllianceBuild(player, message.allianceId, message.buildUid);
	}
}
