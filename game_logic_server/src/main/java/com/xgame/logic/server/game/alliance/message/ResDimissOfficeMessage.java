 ...
 * Alliance-ResDimissOffice - 返回撤职
 */
public class ResDimissOfficeMessage extends ResMessage {
	
	//模块号+消息号
	public static final int ID=1007145;
	//模块号
	public static final int FUNCTION_ID=1007;
	//消息号
	public static final int MSG_ID=145;
