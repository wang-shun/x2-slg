 ...
 * Alliance-ReqDeleteTeamMember - 删除战队成员
 */
public class ReqDeleteTeamMemberMessage extends ReqMessage {
	
	//模块号+消息号
	public static final int ID=1007216;
	//模块号
	public static final int FUNCTION_ID=1007;
	//消息号
	public static final int MSG_ID=216;
