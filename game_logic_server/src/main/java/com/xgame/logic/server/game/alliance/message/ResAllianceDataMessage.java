 ...
 * Alliance-ResAllianceData - 登录返回联盟数据
 */
public class ResAllianceDataMessage extends ResMessage {
	
	//模块号+消息号
	public static final int ID=1007100;
	//模块号
	...
	/**玩家联盟数据*/
	@MsgField(Id = 1)
	public AllianceMemberBean playerAlliance;
	/**联盟数据*/
	@MsgField(Id = 2)
	...
	public String toString(){
		...
		buf.append("playerAlliance:" + playerAlliance +",");
