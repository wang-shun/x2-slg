 ...
 * DefenseSoldier-ResDefensSolderSetup - 注释
 */
public class ResDefensSolderSetupMessage extends ResMessage {
	
	//模块号+消息号
	public static final int ID=132400;
	//模块号
	public static final int FUNCTION_ID=132;
	//消息号
	public static final int MSG_ID=400;
